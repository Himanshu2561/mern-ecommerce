  ...
  return (
    <div className="container h-screen mt-10 mx-auto">
      {isLoading ? (
        ...
        <>
          <div className="border-b-2 border-indigo-500 text-xl text-indigo-500 font-bold uppercase py-1">
            Orders
          </div>
                  ...
                  <tr key={order._id} className="bg-white border-b">
                    ...
                    <td className="px-6 py-4">
                      <Link to={`/order/${order._id}`}>
                        <button className="font-semibold text-indigo-500 hover:text-indigo-600">
                          Details
                        </button>
                      </Link>
                    </td>
